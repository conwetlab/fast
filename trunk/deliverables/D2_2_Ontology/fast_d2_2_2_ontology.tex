...
\singlespacing
\lstset{
	caption={Templating example --- different levels of representation of a FAST screen (TriG)}, 
...
Figure \ref{fig:templating_example_graph} illustrates the same example graphically, using different colours to represent the two different graphs: the red graph in the background represents the original template resource, whereas the green graph in the front in represents the resource copy as it would be used in a concrete screen flow.
...
\subsection{Piping within Screens} % (fold)
