...
\newcommand\authorTwo{Ciprian Palaghita, Cyntelix}
...
%\begin{minipage}[p]{15cm}
	\begin{center}
		...
		\vspace{0.5cm}
		\vfill
		{\large \sffamily Date: 19/01/2010}\\
		\vspace{1cm}
...
1.0 & 19/01/2010 & Ismael Rivera (NUIG) & First version of the deliverable \\
 & & Ciprian Palaghita (Cyntelix) & \\ \hline
\end{tabular}
\end{small}
