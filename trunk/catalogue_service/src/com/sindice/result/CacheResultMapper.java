    ...
    public static void mapTo(CacheResult cacheResult, JSONObject node) {
        ...
        for (Field field : fields) {
            ...
            try {
                if (fieldType.isArray()) {
                ...
                } else if (fieldValue == null || fieldValue.equals("UNKNOWN")) {
                	// Ismael: added UNKNOWN value to fix bug http://code.google.com/p/sindice4j/issues/detail?id=15
                    continue;
                    ...
                    field.set( cacheResult, Enum.valueOf(fieldType, fieldValue.toString().toLowerCase()) );
    ...
    private static Object[] instantiateArray(Class targetType, List jsonArray) {
        ...
        for(int i = 0; i < jsonArraySize; i++) {
            ...
            if(isPrimitive(targetType)) {
                ...
                final Object value = Enum.valueOf(targetType, jsonElement.toString().toLowerCase() );
