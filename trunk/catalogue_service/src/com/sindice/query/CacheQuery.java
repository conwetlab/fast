...
public class CacheQuery extends Query {
     ...
     */
    protected static String getParametersString(Object obj)
    throws IllegalAccessException {
    ...
    public CacheQuery(
        ...
        this(url, fields, ResponseFormat.json, pretty, callback, fieldRegexFilters);
    }
    ...
    public CacheQuery(
        ...
        this(url, fields, false, callback, fieldRegexFilters);
    }
    ...
    public CacheQuery(
        ...
        this(url, fields, null, fieldRegexFilters);
    }
    ...
    public CacheResult performQuery() throws SindiceException {
        ...
        try {
            ...
            queryURL = String.format("%s/v3/cache?%s", SINDICE_ENDPOINT_PREFIX, parametesURL);
        } catch (Exception e) {
