...
public class Pipe implements Comparable<Pipe> {
	...
	public int compareTo(Pipe other) {
		...
		//FIXME: implement checking that all the elmeents in the pipe are equals, not just their URIs
//	    final int BEFORE = -1;
//	    final int EQUAL = 0;
//	    final int AFTER = 1;
//	    
...
//		int comparison = this.conditionFrom.compareTo(other.getConditionFrom());
...
//			if (comparison != EQUAL) return comparison;
//		} else if (this.actionTo == null && other.getActionTo() == null) {
//			return AFTER;
//		} else {
//			return BEFORE;
//		}
