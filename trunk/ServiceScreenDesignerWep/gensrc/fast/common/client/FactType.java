...
//2.2[ !( qualified && !internalQualified ) ]
   ...
   {
      if ( ! JavaSDM.stringEquals (this.domain, value))
      {
         String oldValue = this.domain;
         this.domain = value;
         getPropertyChangeSupport().firePropertyChange(PROPERTY_DOMAIN, oldValue, value);
      }
   }

   public FactType withDomain (String value)
   {
      setDomain (value);
      return this;
   }
   ...
   public void setSubClassOf (String value)
   {
      if ( ! JavaSDM.stringEquals (this.subClassOf, value))
      {
         ...
         getPropertyChangeSupport().firePropertyChange(PROPERTY_SUB_CLASS_OF, oldValue, value);
      }
   }
   ...
   {
      if ( ! JavaSDM.stringEquals (this.tags, value))
      {
         String oldValue = this.tags;
         this.tags = value;
         getPropertyChangeSupport().firePropertyChange(PROPERTY_TAGS, oldValue, value);
      }
   }

   public FactType withTags (String value)
   {
      setTags (value);
      return this;
   }
