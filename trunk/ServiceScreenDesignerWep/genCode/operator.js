run: function (search_key) 
{
  ...
  xmlResponse.getElementsByTagName(Title).getItem(..elemItemID, aus opHandler?..); 
xmlResponse.getElementsByTagName(ViewItemURLForNaturalSearch).getItem(..elemItemID, aus opHandler?..); 
xmlResponse.getElementsByTagName(ConvertedCurrentPrice).getItem(..elemItemID, aus opHandler?..); 
Euro  
