...
UIUtils.onClickCanvas = function(e, /**Optional element*/element){
    ...
    var resourceType = "unknown";
    clickedElement = UIUtils.getResourceDiv(clickedElement);
    resourceType = UIUtils.getResourceType(clickedElement);
    var currentDocument = GVSSingleton.getInstance().getDocumentController().getCurrentDocument();
    switch(resourceType){
        case "screen":
            console.log("screen clicked");
            currentDocument.setSelectedElement(clickedElement);
...
UIUtils.onDblClickCanvas = function(e){
    ...
    var currentDocument = documentController.getCurrentDocument();
    switch(resourceType){
        case "screen":
            console.log("screen dbl-clicked");
            var screenDescription = currentDocument.getResourceInstance(clickedElement.id).getResourceDescription();
        ...
        case "connector":
            ...
            currentDocument.getResourceInstance(clickedElement.id).showPropertiesDialog();
            break;
        case "canvas":
