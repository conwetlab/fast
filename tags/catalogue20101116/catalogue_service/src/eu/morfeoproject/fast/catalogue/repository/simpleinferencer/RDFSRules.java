...
class RDFSRules {
	 ...
	 * aaa rdf:type xxx            (t2)
	 */
	public static final int Rdfs9_1b = 21;
	 ...
	 * aaa rdf:type xxx             (t2)
	 */
	public static final int Rdfs9_2b = 22;
	
	public static final int RULECOUNT = 23;
	...
	public static final String[] RULENAMES = {
			...
			" Rdfs11_2", "  Rdfs12", "  Rdfs13", "  RX1", " Rdfs9_1b", " Rdfs9_2b"};
	...
	public static final boolean[][] TRIGGERS = {
			//	    1    2_2   3_2    4b   5_2   7_1    8    9_2   11_1   12   X1   9_2b
			//	      2_1   3_1    4a   5_1    6    7_2   9_1   10   11_2   13   9_1b
			{
					_, X, _, X, _, X, _, _, _, X, X, _, _, _, X, _, _, _, _, _, _, _, X },// 1
			{
					_, X, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 2_1
			{
					_, X, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 2_2
			{
					_, X, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 3_1
			{
					_, X, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 3_2
			{
					_, X, _, X, _, _, _, _, _, _, X, _, _, _, X, _, _, _, _, _, _, _, X},// 4a
			{
					_, X, _, X, _, _, _, _, _, _, X, _, _, _, X, _, _, _, _, _, _, _, X },// 4b
			{
					_, _, _, _, _, _, _, X, X, _, X, X, _, _, _, _, _, _, _, _, _, _, _ },// 51
			{
					_, _, _, _, _, _, _, X, X, _, X, X, _, _, _, _, _, _, _, _, _, _, _ },// 52
			{
					_, X, _, X, _, _, _, _, _, _, X, X, _, _, _, _, _, _, _, _, _, _, _ },// 6
			{
					_, X, X, X, X, _, _, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X },// 7_1
			{
					_, X, X, X, X, _, _, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X, X },// 7_2
			{
					_, X, _, X, _, _, _, _, _, _, X, _, _, X, _, _, X, X, _, _, _, X, _ },// 8
			{
					_, _, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 9_1
			{
					_, _, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 9_2
			{
					_, X, _, X, _, _, _, _, _, _, X, _, _, _, _, _, _, _, _, _, _, _, _ },// 10
			{
					_, _, _, _, _, _, _, _, _, _, X, _, _, X, _, _, X, X, _, _, _, X, _ },// 11_1
			{
					_, _, _, _, _, _, _, _, _, _, X, _, _, X, _, _, X, X, _, _, _, X, _ },// 11_2
			{
					_, X, _, X, _, _, X, X, X, _, X, X, _, _, _, _, _, _, _, _, _, _, _ },// 12
			{
					_, X, _, X, _, _, _, _, _, _, X, _, _, X, _, _, X, X, _, _, _, X, _ },// 13
			{
					_, X, _, X, _, _, _, _, _, _, X, _, _, _, X, _, _, _, X, _, _, _, X },// X1
			{
					_, _, _, X, _, _, _, _, _, X, X, _, X, _, _, X, _, _, X, X, _, _, _ },// 9_1b don't trigger 9_1 nor 9_2
//					_, _, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 9_1b
			{
					_, _, _, X, _, _, _, _, _, X, X, _, X, _, _, X, _, _, X, X, _, _, _ },// 9_2b don't trigger 9_1 nor 9_2
//					_, _, _, X, _, _, _, _, _, X, X, _, X, _, X, X, _, _, X, X, _, _, X },// 9_2b
